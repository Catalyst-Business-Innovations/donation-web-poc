...
// ── Phase 1 enums ────────────────────────────────────────────────────────────
export enum PointsCalcMethod {
  PerItem = 1,
  PerWeight
} // PerWeight disabled by default
...
export const EMAIL_STARTER_TEMPLATES: EmailStarterTemplate[] = [
  {
    ...
    icon: 'file',
    subject: '',
    blocks: [{ id: 's0', type: 'text', content: '', align: 'left' }]
  },
  {
    ...
    blocks: [
      ...
      { id: 's2', type: 'divider', content: '', align: 'center' },
      {
        ...
        type: 'text',
        content:
          "Hi <strong>{{donor_name}}</strong>,\n\nAs a valued <strong>{{tier}}</strong> member of {{org_name}}, we're reaching out because your past donations have made a real difference in our community.",
        align: 'left'
      },
      {
        id: 's4',
        type: 'text',
        content:
          "We're launching <strong>{{campaign_name}}</strong> and we'd love your support. Every contribution counts!",
        align: 'left'
      },
      ...
      { id: 's6', type: 'spacer', content: '', align: 'center', level: 20 },
      {
        ...
        type: 'text',
        content:
          'You currently have <strong>{{points}} points</strong>. Donate during this campaign to earn bonus points!\n\nThank you for your generosity,\nThe {{org_name}} Team',
        align: 'left'
      }
    ]
  },
  {
    ...
    blocks: [
      ...
      { id: 's2', type: 'divider', content: '', align: 'center' },
      {
        ...
        type: 'text',
        content:
          'Dear <strong>{{donor_name}}</strong>,\n\nOn behalf of the entire {{org_name}} team, we want to sincerely thank you for your generous donation to <strong>{{campaign_name}}</strong>.',
        align: 'left'
      },
      {
        id: 's4',
        type: 'text',
        content:
          "Your contribution directly supports our mission of serving the community. As a <strong>{{tier}}</strong> member, you've been instrumental in making this campaign a success.",
        align: 'left'
      },
      {
        id: 's5',
        type: 'text',
        content:
          'Your loyalty account now has <strong>{{points}} points</strong>. Keep donating to unlock even more rewards!',
        align: 'center'
      },
  ...
  },
  {
    ...
    blocks: [
      { id: 's1', type: 'header', content: "You're Invited!", align: 'center', level: 1 },
      {
        ...
        type: 'text',
        content:
          "Hi <strong>{{first_name}}</strong>,\n\nAs one of our most valued <strong>{{tier}}</strong> donors, we'd love you to join us for a special event.",
        align: 'left'
      },
      { id: 's3', type: 'header', content: '{{campaign_name}}', align: 'center', level: 2 },
      {
        ...
        type: 'text',
        content:
          'Join us for an exclusive event where you can learn about the impact of your donations and connect with other supporters.',
        align: 'center'
      },
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: 's2', type: 'divider', content: '', align: 'center' },
      {
        ...
        type: 'text',
        content:
          'Hi <strong>{{donor_name}}</strong>,\n\nJust a friendly reminder — you have <strong>{{points}} loyalty points</strong> in your {{org_name}} account!',
        align: 'left'
      },
      {
        id: 's4',
        type: 'text',
        content:
          'As a <strong>{{tier}}</strong> member, you can redeem your points for exclusive rewards and discounts.',
        align: 'left'
      },
      { id: 's5', type: 'button', content: 'Browse Rewards', align: 'center', meta: 'https://rewards.example.com' },
      {
        ...
        type: 'text',
        content:
          'Donate during <strong>{{campaign_name}}</strong> to earn even more points!\n\n— The {{org_name}} Team',
        align: 'left'
      }
    ]
  }
